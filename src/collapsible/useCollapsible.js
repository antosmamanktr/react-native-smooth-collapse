...
export const useCollapsible = (expanded, contentHeight, duration, collapsedHeight, onAnimationEnd, onProgress) => {
    // Animation progress (0 → 1)
    const progress = useSharedValue(expanded ? 1 : 0);
    // Height animation
    const height = useSharedValue(expanded ? contentHeight : collapsedHeight);
